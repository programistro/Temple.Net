        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ocrug = table.Column<string>(type: "TEXT", nullable: false),
                    RayonDistrict = table.Column<string>(type: "TEXT", nullable: false),
                    Region = table.Column<string>(type: "TEXT", nullable: false),
                    RayonRegion = table.Column<string>(type: "TEXT", nullable: false),
                    SeparateRegion = table.Column<string>(type: "TEXT", nullable: false),
                    TypeLocality = table.Column<string>(type: "TEXT", nullable: false),
                    Locality = table.Column<string>(type: "TEXT", nullable: false),
                    TempleNameOnMap = table.Column<string>(type: "TEXT", nullable: false),
                    Benevolence = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
